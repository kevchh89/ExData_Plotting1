...
{
  ### 1
  plot(as.numeric(DF$DH)[rowloc],DT2$Global_active_power[rowloc], 
       type='l',xaxt='none',xlab = "",ylab = 'Global Active Power')
  axis(1, seq(97,145,24),las=1,labels = c('Thu','Fri','Sat'))
  ### 2
  plot(as.numeric(DF$DH)[rowloc],DT2$Voltage[rowloc], 
  ...
  ### 4
  plot(as.numeric(DF$DH)[rowloc],DT2$Global_reactive_power[rowloc], 
